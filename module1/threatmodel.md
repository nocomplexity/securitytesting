...
:::{important} 
In Python security testing, it is **essential** to establish a threat model before starting with testing.

All too often, security assessments are reduced to running a number of automated tools against code or an application, without properly considering the complete and relevant scope.
