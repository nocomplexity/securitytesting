...
- [Effective Reporting](reporting): This section focuses on transforming raw technical findings into clear, actionable vulnerability reports.
- [Using CVSS](using_cvss): The Common Vulnerability Scoring System (CVSS) provides a structured and standardised way of rating vulnerability severity. This module section explains how to apply it correctly and responsibly.
- [Risk-Based Reporting](reporting_practices): Severity alone does not determine priority. Risk-based reporting connects technical vulnerabilities to business impact.
